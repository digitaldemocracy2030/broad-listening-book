memo: この資料はマージ済みです。そのうち消します。

# 第7章 広聴AIの開発——Talk to the Cityの実用化への挑戦
...
技術的な詳細については、12章「ブロードリスニング要素技術解説」および13章「広聴AIの技術スタック解説」で説明する。
