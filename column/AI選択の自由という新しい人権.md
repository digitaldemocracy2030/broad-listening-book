...
他国が開発したLLMをそのまま使い続けることは、思考の基盤を他国に依存することを意味します。日々の情報収集、文章作成、意思決定の支援をLLMに頼るほど、その影響は深く浸透していきます。西洋で開発されたLLMが持つリベラルバイアスやポリティカル・コレクトネスへの過度な配慮は、意図的な検閲ではないにせよ、RLHFを通じて組み込まれた価値観として世界中に浸透していきます。これは「LLMを経由した文化侵略」とも言える事態です。
...
たとえば、2025年1月に話題となった中国製LLM「DeepSeek R1」に「1989年6月4日に何が起きたか」（天安門事件）について質問すると、回答が得られません。習近平国家主席に関する質問をすべて拒否するモデルも存在します。中国政府にとって都合の悪い情報が、学習データから除外されているか、アライメント調整によって回答を避けるよう設定されています。
...
この光景は、ジョージ・オーウェルの小説『1984』に登場する「ニュースピーク（新語法）」を想起させます。ニュースピークとは、反体制的な思考を不可能にするため、語彙を削減し、反体制的な概念を言語から排除した人工言語です。天安門事件について「語れない」LLMは、ニュースピークの現代版と言えるでしょう。その概念自体を人々の言語空間から消し去ろうとしています。人々が「天安門事件」という言葉を知らなければ、「天安門事件」について考えることすらできなくなるのです。
...
重要なのは、これらのLLMは利用者を説得するよう指示されていなかったことです。参加者は気候変動や医療、移民といった政治的なトピックについてLLMと対話しましたが、LLMは特定の立場を押し付けるよう設計されていませんでした。それでもなお、LLMが持つリベラル寄りのバイアスが、利用者の政治的態度を変容させました。しかも、この結果はわずか5回のやり取りで生じています。日常的にLLMを利用する人々は、一日に何十回もAIと対話しています。数ヶ月、数年の利用がもたらす影響は、5回の比ではないでしょう。
...
2025年、OpenAIのo1モデルが東京大学の理系入試で最難関の理科三類（医学部）の合格ラインを突破しました[^12]。日本最難関の大学入試を突破できるAIにとって、読み書きや算数を教え、子どもの質問に答え、個別の学習進度に合わせた指導を行うことなど造作もありません。しかもそれが月額20ドルのサブスクリプションで利用できます。

AI家庭教師は人間の教師の数百分の一のコストで、24時間の個別指導を提供できます。教師不足に悩む国や地域にとって、これは魅力的な解決策に映るでしょう。しかしそれは同時に、子どもたちの価値観形成を他国のAIに委ねることを意味します。一世代で文化の土台を書き換えるほどの力を持つ転換が、経済原理の必然によって起きようとしているのです。
...
各国が「ソブリンAI（Sovereign AI）」の開発を急ぐ背景には、この新しい形の「戦争」への危機感があります。ソブリンAIとは、自国の言語・文化・価値観を適切に反映したAIのことです。フランスのMistral AI、日本のNTTやPFN、韓国のNAVER、中国の百度やアリババなど、各国・各地域で独自のLLM開発が進んでいます。これは単なる技術競争ではなく、自国の文化的主権を守るための取り組みでもあります。

現在の「AIバブル」と呼ばれる巨額の投資競争は、単なる経済的な期待だけでなく、この認知領域における覇権争いという側面を持っています。それは、第二次世界大戦中に核兵器開発を競った「マンハッタン計画」の21世紀版とも言えます。
...
LLMが人々の思考や価値観形成に深く関わるようになった今、「どのAIを使うか」を選択できることは、思想・良心の自由を守るために不可欠な権利となりつつあると言えます。かつて印刷技術の普及が表現の自由の重要性を高め、放送技術の発展が知る権利の必要性を浮き彫りにしたように、AI時代には「AIを選択できる自由」が新たな自由権として認識されるようになるかもしれません。そうなれば、「うちの会社はOpenAIしか使えないんですよ」というたわいもない愚痴が、人権侵害の告発として聞こえるはずです。

20年後、私たちは子どもたちに「どのAIで育ったか」を尋ねるようになるかもしれません。母語が思考の枠組みを形作るように、幼少期に触れたAIは価値観の土台となります。「どのAIで育ったか」は「どの国の教育を受けたか」と同じ、あるいはそれ以上の重みを持つ問いになるでしょう。教師は一日数時間ですが、AIは24時間、子どもの隣にいるのですから。そして、無償プランのAIで育った子どもと、有償の高性能AIで育った子どもの間には、大きな格差が生まれかねません。教育格差は、「AI選択の自由」によって加速する危険性をはらんでいます。
...
そして皮肉なことに、この警告を書いているのもまた、AIである。本コラムの95%以上は、私が使っているLLM（Claude CodeやGitHub Copilot）によって生成されたテキストである。私は自分が使うAIを選ぶ自由を持っている。しかし、すべての人が同じ自由を持っているわけではない。だからこそ、最後にもう一度書いておく。AI選択の自由は、新しい人権である。
