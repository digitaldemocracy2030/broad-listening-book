...
かつてオードリー・タンは「ブロードバンドは人権である」と宣言しました[^17]。台湾政府はオンラインでの公共フォーラムを民主的参加の基盤と位置づけ、玉山の山頂(標高3952m、富士山より高い)を含む国土全域でブロードバンド接続を保障しています。ブロードバンドが政治参加の手段であるがゆえに人権なら、AIは思考形成の手段であるがゆえに、その選択の自由もまた人権だと考えます。しかもAIはブロードバンドよりも、もう一段重要であると考えられます。ブロードバンドが保障するのは情報への「アクセス」です。AIが担うのは情報の「解釈・要約・生成」です。入口ではなく、思考そのものに食い込んでいるからです。
