...
こうしたバイアスが生じる主な原因として、RLHF（人間のフィードバックによる強化学習）の影響が指摘されています。LLMは大量のテキストデータで事前学習しただけでは、ユーザーの質問に適切に回答したり、有害な出力を避けたりすることができません。そこで、人間のアノテーター（評価者）がモデルの出力を「良い回答」「悪い回答」とランク付けし、その評価に基づいてモデルを調整するRLHFというプロセスが不可欠となります。このため、アノテーターの価値観や政治的傾向がモデルに反映され、RLHFを経たモデルはより強い政治的見解を示すようになることが研究で明らかになっています[^3]。OpenAI CEOのSam Altman自身もポッドキャストで「最も懸念しているのは評価者のバイアスだ」と述べています[^4]。
...
幸いなことに、日本は十分な言語資源を持ち、独自のLLMを開発できる国力があります。国立国会図書館は約35万点のデジタル化資料を公開しており、国立情報学研究所（NII）と連携してLLM学習用のテキストデータ提供を進めています[^13]。明治期から現代までの膨大な日本語テキストは、日本独自のLLMを構築するための貴重な資源です。日本語で書かれた意見を、日本の文化的文脈を理解したモデルで分析できることが望ましいと言えます。現在、日本政府も国産LLMの開発支援に乗り出しており、経済産業省は2024年度から国内のLLM開発に対して大規模な補助金を交付しています。これらの投資は経済安全保障や産業競争力の強化が主眼ですが、結果として自国の言語・文化に根ざしたAI基盤を整備することにもつながります。
...
[^8]: ITmedia AI+「話題の中華LLM『DeepSeek R1』は、天安門事件を説明できるか」(2025) https://www.itmedia.co.jp/aiplus/articles/2501/23/news179.html
[^9]: 日経ビジネス「中国、AIにも検閲拡大」(2024) https://business.nikkei.com/atcl/NBD/19/world/00661/
[^10]: arXiv "The Invisible Megaphone: Analysis of Propaganda Bias and Anti-American Sentiment in Chinese LLMs vs. Western LLMs" (2025) https://arxiv.org/abs/2506.01814
...
[^13]: 国立国会図書館「国立情報学研究所における大規模言語モデル構築への協力について」(2024) https://www.ndl.go.jp/jp/news/fy2023/240130_01.html
[^14]: ITmedia AI+「デジ庁、『国産LLM』の公募開始 行政向けAIに実装へ」(2025) https://www.itmedia.co.jp/aiplus/articles/2512/02/news066.html
[^15]: デジタル庁「ガバメントAIプラットフォーム『源内』におけるPFNの翻訳モデルの利用開始」(2025) https://www.digital.go.jp/news/b27d1af7-c231-4ab3-ad78-fc5408d44504
