...
こうしたバイアスが生じる原因として、学習データがReddit（左派寄りのユーザーベースを持つ[^3]）などのプラットフォームから多く収集されていることに加え、RLHF（人間のフィードバックによる強化学習）の影響が指摘されています[^15]。同記事で引用されているポッドキャストで、OpenAI CEOのSam Altman自身も「最も懸念しているのは評価者のバイアスだ」と述べています。

LLMを意見の要約や分類のタスクに使った場合、こうしたバイアスにより保守的な意見が過小評価されたり、表現がリベラル寄りに言い換えられたり、あるいは完全に取り除かれたりするリスクがあります。例えば、移民政策や伝統的価値観に関する意見を要約する際、LLMが無意識のうちに表現を中和したり、特定の立場を「問題のある意見」として扱ったりする可能性があります。
...
[^15]: Brookings Institution "The politics of AI: ChatGPT and political bias" (2023) https://www.brookings.edu/articles/the-politics-of-ai-chatgpt-and-political-bias/
