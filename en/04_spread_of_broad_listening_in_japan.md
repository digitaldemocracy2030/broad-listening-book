...
At Anno’s campaign launch press conference, a message of support from Audrey Tang, who served as Taiwan’s digital minister, was introduced[^anno-kaiken]. In it, Tang said, “Anno is not engaged in protest. ... He is saying, ‘We can change for the better.’” This echoes the principle Tang has repeatedly articulated: not a demo for protest, but a demonstration (“demo”) that shows technology[^audrey-manifesto].

In Anno’s Tokyo governor race, a “technological demonstration” of exactly “what is possible with today’s technology” was carried out by making use of the high-profile opportunity presented by the election. The concept of “broad listening,” which became widely known there, would then spread rapidly over the following year—from elections to news reporting, the Japanese Parliament, and journalism.

## What Happened in the Year After the Tokyo Governor Election

In the October 2024 House of Representatives election, Nippon TV introduced broad listening into its election coverage. By using AI to analyze and visualize voices on X related to the election and broadcasting the results in a terrestrial TV election special, it likely became the world’s first example of broad listening being used in television news coverage. During the same lower house election period, the “Public Opinion Map” was released as part of the election information site JAPAN CHOICE. By embedding Polis and allowing voters to cast votes themselves, it attempted to visualize the multidimensional distribution of opinions[^polis_dim], becoming the largest application of Polis in Japan.

In March 2025, House of Councillors member Takae Ito of the Democratic Party for the People presented a “Map of Issues” created by TTTC as reference material in the Budget Committee, pointing out that the challenges facing people who came of age during Japan's long hiring slump of the late 1990s and early 2000s cannot be fully covered by policies focused narrowly on employment. It was the first time in Japan’s Parliament that the results of broad listening were used as the basis for questioning the government.
...
[^polis_dim]: In Polis, participants enter agree/disagree responses for each opinion, so each participant is represented as a vector with as many dimensions as there are opinions. Polis compresses this multidimensional data into two dimensions through principal component analysis and visualizes it. See Section 4.4 for details.
