...
## In 2002, Taiwan held its first deliberation experiment

In 2002, Taiwan held its first deliberative exercise.
The theme was the scope of coverage under the National Health Insurance system:
within limited financial resources, which medical services should be covered by public funds, and which should require out-of-pocket payment?
It was a topic that would still feel highly relevant in Japan in 2026.
In this experiment, 20 ordinary citizens received lectures from experts and then engaged in deliberation.

Before participating, they had little understanding of the health insurance system. But through background materials and expert explanations, they acquired the basic knowledge they needed and were able to discuss policy rationally from the standpoint of the public interest. Shared baseline knowledge also increased the amount of information participants could reasonably assume others already understood, creating a common foundation for discussion.
This also reduced disparities in opportunities to speak.

The experiment also showed that listening to expert lectures did not simply cause participants to adopt the experts’ views. Participants were able to distinguish between experts explaining facts and experts expressing value judgments. They respected experts as sources of knowledge, but did not regard them as the ultimate authority in policymaking.
...
On March 18, 2014, amid controversy over deliberations on the Cross-Strait Service Trade Agreement with China, more than 300 students occupied the Legislative Yuan building, Taiwan’s legislature. The agreement would have deepened economic ties with China, and many were concerned about its impact on Taiwan’s industries and national security. In addition, the ruling party’s attempt to force a vote without sufficient deliberation triggered the students’ direct action.
The Legislative Yuan was occupied for 23 days, while thousands to tens of thousands of citizens who supported the students surrounded the building.
...
g0v made a major contribution to this two-way communication over the internet. Because it had repeatedly organized hackathons, g0v had a CPR team (Cable, Power, Radio) with expertise in event setup, and more than 100 g0v members were involved in the livestreaming effort. One well-known anecdote is that Audrey Tang, who would later become digital minister, laid 350 meters of CAT-6 cable. But this was not the story of one heroic individual; it was made possible by the efforts of many citizens.
...
- Q3: I am an Uber driver.

#### Values

- Q4: I think it is acceptable to raise fares flexibly during peak hours.
- Q5: I think drivers should be allowed to accept work simultaneously from multiple ride-hailing companies (platforms).
- Q6: I think it is the responsibility of the Ministry of Transportation and Communications to actively crack down on unlicensed taxis.

#### Legal issues

- Q7: I think vehicles carrying passengers should have clear markings.
- Q8: I think all drivers carrying passengers should be enrolled in injury insurance (accident insurance).
- Q9: I think Uber should pay taxes to the government in the area where it operates.
- Q10: I think records of dispute resolution on the Uber platform should be reported to the Ministry of Transportation and Communications.

Regarding the questions on legal issues, there was a view that they should be expressed not in technical legal language but in terms any ordinary participant could understand. Audrey Tang and Chia-liang Kao (clkao) were responsible for translating them into plain language for the general public.

This Polis survey was published no later than June 30, with a goal of collecting 500 votes by August 15. On July 17, the Ministry of Transportation and Communications added the following four questions and sent letters to stakeholders in the taxi industry. By that point, users had already added seven questions, and there appear to have been 66 respondents.

- I believe UberX is currently not operating in compliance with the law, so I feel there are risks when using it.
- I feel that UberX’s management system lacks sufficient transparency and does not inspire confidence.
- I feel that UberX is creating unfair competition with the existing domestic transportation industry.
- I think UberX should apply to operate its transportation business in compliance with the law.

In the end, 1,326 users cast enough votes to be included in the analysis, and the total number of statements reached 199.

[^hackpad20150626]: Minutes from 6/26 to 7/17: https://g0v.hackpad.tw/ep/pad/static/X4bWlGs0MuJ

[^footnote1]: Although the process was designed this way at the outset, Q2 and Q3 appear to have been disabled fairly early on. Also, because Polis does not display questions in a fixed order, once user-submitted questions increased, it likely no longer functioned exactly as originally intended.
...
Gradually, the focus shifted to questions such as whether Uber would bear legal responsibility in Taiwan and how much tax it was paying there. Finally, Jaclyn Tsai closed the meeting by saying, “Just because something is innovation does not mean it can avoid paying taxes or bearing legal responsibility.”
...
### 2023: Deliberation using Polis and Talk to the City

The first attempt in 2023 combined online and offline participation effectively.

First, on July 29, an ideathon was held to organize key issues concerning AI in society. The issues identified there were fed into Polis during July, and citizens’ views were collected online until around August 20. The results were then visualized using Talk to the City and used as material for deliberation at an event in Taipei on August 26 and another in Tainan on September 16. These Taipei and Tainan events were held offline.

Both Polis and Talk to the City are visualized as scatterplots with many points, but what they represent is entirely different. In Polis, one point represents one person, and people with similar views are displayed near one another. In Talk to the City, by contrast, one point represents one opinion, and opinions with similar themes are displayed near one another. By using Talk to the City, the many opinions submitted by large numbers of people can be visualized as a map of “what kinds of views exist.”

However, the 2023 workshops had limits in terms of representativeness. Many participants were people who joined voluntarily because they were already interested, or experts who had been invited. Because the proportion of people from digital technology fields was high, the official report explicitly noted that the participant composition was not representative of society as a whole.

### Overcoming the representativeness problem: mini-publics

One approach to this problem is the use of mini-publics. As explained in Chapter 2, mini-publics are a method in which a small but representative group of citizens is formed through random selection to mirror society as a whole, and that group then engages in deliberation.

On March 23, 2024, Taiwan’s Ministry of Digital Affairs, in collaboration with Stanford University’s Deliberative Democracy Lab and the Institute of Science, Technology and Society at National Yang Ming Chiao Tung University, conducted a citizen deliberation using the mini-publics method on the theme of “improving information integrity using AI.”

In Taiwan, there is an official sender number, 111, that the government uses when sending SMS messages to the public. Government agencies can send text messages to citizens through this number. This is not an emergency number citizens call, like 110 in Japan, but a notification-only infrastructure for communication from government to citizens. It was institutionalized in October 2023 in light of two developments during the COVID-19 period: SMS had become established as an administrative user interface, and SMS scams impersonating the government had increased as a result.
	
Using this system, the government sent random invitations to participate in online deliberation to 200,000 citizens and received 1,760 expressions of interest. From those, it conducted stratified sampling by gender, age, and place of residence, selecting 447 citizens whose composition reflected Taiwan’s population.

Participants were divided into 44 groups and held discussions on the Stanford Online Deliberation Platform, developed by Stanford University’s Deliberative Democracy Lab. This platform resembles a video-conferencing system, but it includes features such as countdowns or cutoffs when one person speaks for too long, a visible queue for those who wish to speak next, and prompts encouraging participation from those who have spoken little. In other words, it is designed to ensure equal speaking opportunities so that discussion does not become a one-person show dominated by the loudest voices.

As a result of the deliberation, 85% of citizens supported the view that “platforms should bear the primary responsibility for improving information integrity,” and just four months later, on July 31, the Fraud Crime Hazard Prevention Act came into force. Normally, legislation regulating major platforms takes a long time because of industry lobbying and political bargaining. But in this case, the “considered public opinion” generated by a mini-public helped push the legislative process forward.

### The significance and limits of mini-publics

Taiwan’s case shows one path toward increasing the representativeness of deliberation. At the same time, it also has limits. Even after sending SMS invitations to 200,000 people, only 1,760 applied. In other words, less than 1% of citizens invited even applied in the first place. Those selected were likely people eager for new experiences and interested in online discussion on an abstract theme like “improving information integrity using AI.” Even so, one advantage is that stratified sampling made the demographic proportions of participants equivalent to those of the actual population. That makes it possible to respond to criticisms such as, “Online discussion only reflects the views of young people.” At the same time, turnout among young people is low in paper-ballot elections as well, which means those processes also fail to match actual population proportions and can be said to face a similar problem.
...
What matters is not only the citizen proposals produced in individual cases or the digital tools used there. Rather, by repeatedly conducting this kind of experiment in citizen participation, citizens who take part become more interested in public issues, come to recognize that they have both the right and the ability to think about such issues, and a virtuous cycle begins. This is exactly what has been observed repeatedly since Taiwan’s first deliberation experiment in 2002.

In Japan, during the 2024 Tokyo governor election, broad listening that collected and visualized comments from social media without deliberation attracted attention, and within two years a variety of actors had begun implementing it. As Taiwan’s experience with deliberation suggests, increasing the number of spaces where citizens are first given the necessary background knowledge and then invited to discuss may help Japan move in a better direction.
