...
**Questions for AI Anno**: The campaign offered “AI Anno,” an AI avatar that explained policies on YouTube Live. When viewers wrote questions in the comments, the AI searched the manifesto data and answered by voice in real time. This was not one-on-one interaction with an AI; it was a communication style in which the whole audience could watch what other people asked and how AI Anno answered. Over 14 days of operation, AI Anno answered about 6,200 questions. Although the system was originally designed for communicating policies, the questions it received also became a source of information about what people were interested in. Technically, these were collected through the YouTube comments API.

**AI voice phone**: This made the AI Anno system usable by phone. By combining IP telephony with real-time speech-to-text, the campaign connected telephone calls to the AI Anno question-and-answer system. It was designed as a way for people less comfortable with electronic text input to interact through the more familiar medium of voice. Over 10 days, it answered more than 830 questions, and like the questions submitted to AI Anno on YouTube, this also became a useful information source.
