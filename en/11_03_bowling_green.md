# Bowling Green: “America’s Largest Town Hall”

## Bowling Green’s Challenge

Taiwan’s vTaiwan was a pioneering example of consensus-building using Polis. The second case introduced here is a large-scale civic dialogue project conducted in a single U.S. city.

Bowling Green, located in southern Kentucky, is a city of about 76,000 people. If you search for “Bowling Green, KY” on a map app, you can see new residential developments spreading one after another across gently rolling farmland. Several factors have driven its growth: spillover from Nashville’s rapid economic expansion, about an hour away by car; the arrival of immigrants from around the world through a refugee resettlement center; and a strong employment base centered on Western Kentucky University and General Motors’ Corvette plant. As a result, the population grew by about 1.5 times between 2000 and 2020. According to projections by the University of Louisville’s Kentucky State Data Center, Warren County’s population is expected to reach about 230,000 by 2050.
...
## Polis + Sensemaker: From Opinion Collection to AI Analysis
...
## “What Could BG Be?”: A 33-Day Experiment
...
## The Consensus Map Revealed by AI
...
## From Voice to Policy: Achievements and Limits
...
That said, this success comes with an important qualification. The more abstract an opinion is, the easier it is to agree with; the more concrete it becomes, the more people split. More than 80% may agree on “more family-friendly activities.” But if the proposal becomes “build a new park on this specific street,” agreement falls. If it goes further and says “raise property taxes in this specific district to pay for park maintenance,” consensus collapses. Even when people begin from the same desire to improve parks, the boundaries of interest become visible as soon as location, budget, and who pays are specified. The consensus extracted by AI becomes more fragile as the level of specificity rises. This is not a flaw in the technology, but an inherent feature of human consensus-building itself. That is precisely why a stage like the pillar groups, in which people take the AI’s output and turn it into concrete proposals, is indispensable. AI can make the consensus space visible. Deciding where to go from there remains human work.

## “We The People”: Scaling the Model Nationwide
