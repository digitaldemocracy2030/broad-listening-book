...
(Footnote:  
This section is a reconstruction for this book based on the author’s blog post, [Insights Gained from Team Mirai’s Social Experiment, the “Interactive Policy Platform”](https://note.com/nishiohirokazu/n/nb35e8d526fd4).)
...
## The Interactive Policy Platform: Making Dialogue the Entry Point
...
![Figure: The spoken manifesto flow, where AI conversations with voters become policy proposals on GitHub.](images/06_01_manifesto_flow_en.png)
...
## Visualization and Observation with Kouchou AI

Although it was not publicly announced, by May 22 the team had internally reached a point where it could carry out broad listening, visualize the results, and observe the submissions. The broad listening tool used was Kouchou AI (広聴AI, Broad Listening AI), developed by the Digital Democracy 2030 project launched by Anno[^dd2030].

[^dd2030]: The Digital Democracy 2030 project and Kouchou AI are explained again in detail in Chapter 10.
[^eyeglasses]: At Funding the Commons Tokyo 2024, Audrey Tang described this idea roughly as follows: around 2014, when initiatives such as vTaiwan began, they did not tell policymakers and bureaucrats, “We will replace you with crowdsourcing” or “The wisdom of the internet will take over.” Instead, they framed the tools as assistive technology, like glasses: “We help you see better. If you put on glasses, you can see more clearly and understand more of society’s voices and ideas. That reduces risk. Without the glasses, you might miss issues people consider important, leading to occupations of parliament or intense protests.” In design-thinking terms, this corresponds to better exploration and better definition of shared issues.
...
## When Discussion Starts on GitHub
...
(A) People in the same place, (B) individual AI chats, and (C) people connected through AI
