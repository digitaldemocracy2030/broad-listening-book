...
そして10月27日の投開票日には、「zero選挙2024 日本は、こう変わる」と題された地上波の選挙特番が放送された。投票締め切りの20時から約25分間に投稿された衆院選に関するXの投稿を収集し、TTTCで分析してレポートを作成。番組内では安野が散布図の解説を行い、投票締め切り直後の有権者の声をリアルタイムに近い形で届けた。

なお、作成された各レポートは番組での利用にとどまらず、インターネット上でも一般に公開された。
...
散布図では、1つの点が1件の意見を表している。意味的に似た意見ほど近くに配置され、同じクラスタに属する意見は同じ色で表示される。なお、縦軸・横軸自体には特定の意味はなく、高次元のデータを2次元に圧縮して配置したものである。
